...
.showMsg .bottom{ background:#fff; margin: 0 1px 1px 1px;line-height:26px; *line-height:30px; height:26px; text-align:center}
...
<body style="background:url(<?php echo IMG_PATH;?>thy_img/ios9_bg.jpg);">
<div id="main_login" >
<div class="showMsg" style="text-align:center">
	<h5>提示信息</h5>
    <div class="content guery" style="display:inline-block;display:-moz-inline-stack;zoom:1;*display:inline; max-width:280px; color:#FFF; font-size:16px; "><?php echo $msg;?></div>
	...
	<a href="<?php echo strip_tags($url_forward);?>" style="color:#FFF;">如果您的浏览器没有自动跳转，请点击这里</a>
