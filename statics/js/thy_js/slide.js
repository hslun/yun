(function($) {
	$.fn.slide = function(options) {
		...
		$("<ul style='width:" + ($(settings.slideContainer).length * 14 + ($(settings.slideContainer).length - 1) * 5) + "px;margin-left:-" + ($(settings.slideContainer).length * 14 + (($(settings.slideContainer).length - 1) * 5)) / 2 + "px' class='navListBox'>" + navlist + "</ul>").appendTo(el.parent());
